...
class StateMachineNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("touch_threshold", 20.0)
        ...
        self.start = self.get_clock().nanoseconds / 1e9
    ...
    def timer_callback(self):
        ...
        for i in range(3):
            for j in range(3):
                ...
                marker.pose.position.x = contact_locs[index[i], j, 0]
                marker.pose.position.y = contact_locs[index[i], j, 1]
                marker.pose.position.z = contact_locs[index[i], j, 2]
                marker.scale.x = 0.05
                marker.scale.y = 0.05
                marker.scale.z = 0.05
                marker.color.a = 1.0
